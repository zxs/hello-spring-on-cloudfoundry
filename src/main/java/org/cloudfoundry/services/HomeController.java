...
public class HomeController {
	...
	@RequestMapping("/jquery-file-uploads-min")
	public String fileUploadsMin() {
		return "fileuploads/blueimp-fileupload-min";
		
	}
	@RequestMapping("/jquery-file-uploads-mix")
	public String fileUploadsMix() {
		return "fileuploads/blueimp-fileupload-mix";
	}
	@RequestMapping("/jquery-file-uploads-mix-hdfs")
	public String fileUploadsMixHdfs() {
		return "fileuploads/blueimp-fileupload-mix-hdfs";
